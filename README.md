...
<head>
    ...
    <style type="text/css">
        ...
        .box {
            ...
            min-height: 300px;
            font-size: 20px;
            background: rgb(158, 76, 124);
            background: linear-gradient(90deg, rgb(182, 67, 67) 9%, rgb(172, 14, 14) 56%);
            border-radius: 10px;
...
## OUTPUT:
![Alt text](<Screenshot 2023-11-14 091852.png>)
![Alt text](<Screenshot 2023-11-14 091935.png>)
